...
DYJetsToNuNu_HT100to200       = Sample.nanoAODfromDAS("DYJetsToNuNu_HT100to200",       "/ZJetsToNuNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",        dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=280.35*1.23)
DYJetsToNuNu_HT200to400       = Sample.nanoAODfromDAS("DYJetsToNuNu_HT200to400",       "/ZJetsToNuNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",        dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=77.67*1.23)
...
TTHbb               = Sample.nanoAODfromDAS("TTHbb",            "/ttHJetTobb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",                                 dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.5085*(0.577))
TTHnobb             = Sample.nanoAODfromDAS("TTHnobb",          "/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM ",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.5085*(1-0.577))
...
tZq_ll               = Sample.nanoAODfromDAS("tZq_ll",           "/tZq_ll_4f_ckm_NLO_TuneCP5_13TeV-amcatnlo-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",                             dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.09418 ) #0.0758 )
...
TTZToQQ             = Sample.nanoAODfromDAS("TTZToQQ",          "/TTZToQQ_TuneCP5_13TeV-amcatnlo-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",                       dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.5297)
#TTZToLLNuNu         = Sample.nanoAODfromDAS("TTZToLLNuNu",       "",         dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.2728)
...
TTGJets             = Sample.nanoAODfromDAS("TTGJets",          "/TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",           dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=3.697)
...
## fixed samples!!
TTGHad_LO                   = Sample.nanoAODfromDAS("TTGHad_LO",             "/TTGamma_Hadronic_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",  dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=4.213*2.565)
...
TTGSingleLep_LO             = Sample.nanoAODfromDAS("TTGSingleLep_LO",             "/TTGamma_SingleLept_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",  dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=5.125*1.994)
...
TTGLep_LO                   = Sample.nanoAODfromDAS("TTGLep_LO",             "/TTGamma_Dilept_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",  dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=1.512*1.616)
...
TTV = [TTGLep_LO , tZq_ll, TTZToQQ, TTGHad_LO, TTGSingleLep_LO  ]
#TTV = [
#    TGJets,
#    TGJets_ext,
#    TGJets_lep,
...
## di/multiboson
WWTo2L2Nu           = Sample.nanoAODfromDAS("WWTo2L2Nu",        "/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM", dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=12.178)
...
ZZTo2L2Nu           = Sample.nanoAODfromDAS("ZZTo2L2Nu",            "/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",                   dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.564)
...
WZTo3LNu_amcatnlo   = Sample.nanoAODfromDAS("WZTo3LNu_amcatnlo",    "/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",      dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=4.666)
...
WGToLNuG                = Sample.nanoAODfromDAS("WGToLNuG", 	     "/WGToLNuG_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",         dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=377.7*1.295) # NLO xsec from TOP-17-016 for 2016
WGToLNuG_amcatnlo       = Sample.nanoAODfromDAS("WGToLNuG_amcatnlo", "/WGToLNuG_01J_5f_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM", dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=203.3) 
...
ZGToLLG             = Sample.nanoAODfromDAS("ZGToLLG",              "/ZGToLLG_01J_5f_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",   dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=50.2)
...
W1JetsToLNu     = Sample.nanoAODfromDAS("W1JetsToLNu",          "/W1JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",         dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=11524.) #9602. #NLO xsec from AN-2016/289
W2JetsToLNu     = Sample.nanoAODfromDAS("W2JetsToLNu",          "/W2JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",         dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=3788.) #3167. #NLO xsec from AN-2016/289
W3JetsToLNu     = Sample.nanoAODfromDAS("W3JetsToLNu",          "/W3JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",         dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=1144.) #948.5 #NLO xsec from AN-2016/289
...
## HT-binned
WJetsToLNu_HT70to100        = Sample.nanoAODfromDAS("WJetsToLNu_HT70to100",        "/WJetsToLNu_HT-70To100_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",      dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=1637.13)
WJetsToLNu_HT100to200       = Sample.nanoAODfromDAS("WJetsToLNu_HT100to200",       "/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=1627.45)
WJetsToLNu_HT200to400       = Sample.nanoAODfromDAS("WJetsToLNu_HT200to400",       "/WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=435.237)
WJetsToLNu_HT400to600       = Sample.nanoAODfromDAS("WJetsToLNu_HT400to600",       "/WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=59.1811)
WJetsToLNu_HT600to800       = Sample.nanoAODfromDAS("WJetsToLNu_HT600to800",       "/WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=14.5805)
WJetsToLNu_HT800to1200      = Sample.nanoAODfromDAS("WJetsToLNu_HT800to1200",      "/WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",    dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=6.65621)
WJetsToLNu_HT1200to2500     = Sample.nanoAODfromDAS("WJetsToLNu_HT1200to2500",     "/WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",   dbFile=dbFile, overwrite=ov, redirector=redirector, xSection=1.60809)
...
TTWZ = Sample.nanoAODfromDAS("TTWZ", "/TTWZ_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM", dbFile=dbFile, redirector=redirector, xSection=0.002919)
TTZZ = Sample.nanoAODfromDAS("TTZZ", "/TTZZ_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM", dbFile=dbFile, redirector=redirector, xSection=0.001573)
...
GluGluToContinToZZTo2e2mu   = Sample.nanoAODfromDAS("GluGluToContinToZZTo2e2mu",   "/GluGluToContinToZZTo2e2mu_TuneCP5_13TeV-mcfm701-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",    dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.005423)
GluGluToContinToZZTo2e2tau  = Sample.nanoAODfromDAS("GluGluToContinToZZTo2e2tau",  "/GluGluToContinToZZTo2e2tau_TuneCP5_13TeV-mcfm701-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",   dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.005423)
GluGluToContinToZZTo2mu2tau = Sample.nanoAODfromDAS("GluGluToContinToZZTo2mu2tau", "/GluGluToContinToZZTo2mu2tau_TuneCP5_13TeV-mcfm701-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",  dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.005423)
...
GluGluToContinToZZTo4tau    = Sample.nanoAODfromDAS("GluGluToContinToZZTo4tau",    "/GluGluToContinToZZTo4tau_TuneCP5_13TeV-mcfm701-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=0.0027)
...
QCD_Mu_pt50to80         = Sample.nanoAODfromDAS("QCD_Mu_pt50to80",            "/QCD_Pt-50To80_MuEnrichedPt5_TuneCP5_13TeV-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=445700.0)
...
QCD_Mu_pt300to470       = Sample.nanoAODfromDAS("QCD_Mu_pt300to470",          "/QCD_Pt-300To470_MuEnrichedPt5_TuneCP5_13TeV-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=797.5)
...
QCD_Mu_pt470to600       = Sample.nanoAODfromDAS("QCD_Mu_pt470to600",          "/QCD_Pt-470To600_MuEnrichedPt5_TuneCP5_13TeV-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=78.67)
...
QCD_Mu_pt1000toInf      = Sample.nanoAODfromDAS("QCD_Mu_pt1000toInf",         "/QCD_Pt-1000_MuEnrichedPt5_TuneCP5_13TeV-pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, overwrite=ov, xSection=1.605)
...
#QCD_pt15to30            = Sample.nanoAODfromDAS("QCD_pt15to30",               "/QCD_Pt_15to30_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=1837410000*1.0) #xSection = xsec * filter eff
#QCD_pt30to50            = Sample.nanoAODfromDAS("QCD_pt30to50",               "",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=140932000*1.0) #xSection = xsec * filter eff
#QCD_pt50to80            = Sample.nanoAODfromDAS("QCD_pt50to80",               "/QCD_Pt_50to80_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=19204300*1.0) #xSection = xsec * filter eff
#QCD_pt80to120           = Sample.nanoAODfromDAS("QCD_pt80to120",              "/QCD_Pt_80to120_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=2762530*1.0) #xSection = xsec * filter eff
#QCD_pt120to170          = Sample.nanoAODfromDAS("QCD_pt120to170",             "/QCD_Pt_120to170_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=471100*1.0) #xSection = xsec * filter eff
#QCD_pt170to300          = Sample.nanoAODfromDAS("QCD_pt170to300",             "/QCD_Pt_170to300_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=117276*1.0) #xSection = xsec * filter eff
#QCD_pt300to470          = Sample.nanoAODfromDAS("QCD_pt300to470",             "QCD_Pt_300to470_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=7823*1.0) #xSection = xsec * filter eff
#QCD_pt470to600          = Sample.nanoAODfromDAS("QCD_pt470to600",             "/QCD_Pt_470to600_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=648.2*1.0) #xSection = xsec * filter eff
#QCD_pt600to800          = Sample.nanoAODfromDAS("QCD_pt600to800",             "/QCD_Pt_600to800_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=186.9*1.0) #xSection = xsec * filter eff
#QCD_pt800to1000         = Sample.nanoAODfromDAS("QCD_pt800to1000",            "/QCD_Pt_800to1000_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=32.293*1.0) #xSection = xsec * filter eff
#QCD_pt1000to1400        = Sample.nanoAODfromDAS("QCD_pt1000to1400",           "/QCD_Pt_1000to1400_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=9.4183*1.0) #xSection = xsec * filter eff
#QCD_pt1400to1800        = Sample.nanoAODfromDAS("QCD_pt1400to1800",           "/QCD_Pt_1400to1800_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=0.84265*1.0) #xSection = xsec * filter eff
#QCD_pt1800to2400        = Sample.nanoAODfromDAS("QCD_pt1800to2400",           "/QCD_Pt_1800to2400_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=0.114943*1.0) #xSection = xsec * filter eff
#QCD_pt2400to3200        = Sample.nanoAODfromDAS("QCD_pt2400to3200",           "/QCD_Pt_2400to3200_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=0.00682981*1.0) #xSection = xsec * filter eff
#QCD_pt3200toInf         = Sample.nanoAODfromDAS("QCD_pt3200toInf",            "/QCD_Pt_3200toInf_TuneCP5_13TeV_pythia8/RunIISummer20UL16NanoAODv2-106X_mcRun2_asymptotic_v15-v1/NANOAODSIM",     dbFile=dbFile, redirector=redirector, instance="phys03", overwrite=ov, xSection=0.000165445*1.0) #xSection = xsec * filter eff
