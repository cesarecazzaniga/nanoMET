...
from tunes_dimuon import tuneParams
...
if year == 2016:
    if options.prevfp:
        from nanoMET.nanoAOD.UL16_nanoAODAPVv9_preVPF import allSamples as UL16_nanoAODAPVv9
        from nanoMET.nanoAOD.UL16_DATA_nanoAODAPVv9_preVPF import allSamples as UL16_DATA_nanoAODAPVv9
        allSamples =  UL16_nanoAODAPVv9 + UL16_DATA_nanoAODAPVv9
    else:
        from nanoMET.nanoAOD.UL16_nanoAODv9_postVPF import allSamples as UL16_nanoAODv9
        from nanoMET.nanoAOD.UL16_DATA_nanoAODv9_postVPF import allSamples as UL16_DATA_nanoAODv9
    ...
    if options.era == "v2":
        ...
        from nanoMET.nanoAOD.UL18_DATA_nanoAODv9 import DoubleMuon_Run2018 as UL18_DATA_nanoAODv9
