...
if args.year == 2016:
    postProcessing_directory = "2016_UL%s_%s/singlemu/"%(preVFP_string, args.addon)
    trigger                  = ["HLT_IsoMu24"]
    METPtVar                 = "MET_pt"
    METPhiVar                = "MET_phi"
    ...
    if args.prevfp:
        if args.runData:
            ...
            from nanoMET.samples.nanoTuples_Run2016_ULnanoAODv9_preVFP_postProcessed_mu import *
            samples              = [SingleMuon_Run2016_preVFP]
            ...
            from nanoMET.samples.nanoTuples_UL16_nanoAODv9_preVFP_postProcessed_mu  import *
            samples              = [DY_LO_16, Top_16, diboson_16, rare_16, QCD_16, WJets_16]
            jer                  = "Summer20UL16APV_JRV3_MC"

    else:
        if args.runData:
            #from nanoMET.samples.nanoTuples_Run2016_ULnanoAODv9_postProcessed_mumu import *
            from nanoMET.samples.nanoTuples_Run2016_ULnanoAODv9_postProcessed_mu import *
            samples              = [SingleMuon_Run2016]
            jer                  = "Summer20UL16_JRV3_DATA"
        else:
            #from nanoMET.samples.nanoTuples_UL16_nanoAODv9_postProcessed_mumu import *
            from nanoMET.samples.nanoTuples_UL16_nanoAODv9_postProcessed_mu import *
            samples              = [DY_LO_16, Top_16, diboson_16, rare_16, QCD_16, WJets_16]
    ...
    if str(args.addon) == "v9":
        postProcessing_directory = "2017_UL_v9/singlemu/"
        if args.runData:
            from nanoMET.samples.nanoTuples_Run2017_ULnanoAODv9_postProcessed_mu import *
            samples              = [SingleMuon_Run2017]
            jer                  = "Summer19UL18_JRV2_DATA"
        else:
            from nanoMET.samples.nanoTuples_UL17_nanoAODv9_postProcessed_mu import *
            samples              = [DY_LO_17, Top_17, diboson_17, rare_17, QCD_17, WJets_17]
            jer                  = "Summer19UL18_JRV2_MC"


elif args.year == 2018:

    trigger                  = ["HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8"]
    METPtVar                 = "MET_pt"
    METPhiVar                = "MET_phi"
    JetCollection            = "Jet_pt"
    vetoEtaRegion            = (10.,10.)
    ...
    if str(args.addon) == "v9": 
        ...
        postProcessing_directory = "2018_UL_v9/doublemu_UL_2018_v9"

        if args.runData:
            from nanoMET.samples.nanoTuples_Run2018_ULnanoAODv9_postProcessed_mumu import *
            samples              = [Run2018]
            jer                  = "Summer19UL18_JRV2_DATA"
        else:
            from nanoMET.samples.- nanoTuples_UL18_nanoAODv9_postProcessed_mumu_tuning import *
...
outfile         = "results/doubleMUALLComplete_UL_tune_%s_%i_%s_%s_sumPt%i_max%i"%("DATA" if args.runData else "MC", args.year, jer, args.selection, args.jetThreshold, args.maxSig)
if args.addon:
